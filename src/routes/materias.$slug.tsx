...
function GenericSubjectLayout() {
  ...
  if (!disciplina) {
    return (
      <div className="mx-auto flex min-h-[70vh] max-w-2xl flex-col items-center justify-center px-4 py-12 text-center">
        ...
        <p className="mt-4 text-muted-foreground">Não localizei uma disciplina com esse endereço.</p>
  ...
  const d = resolveDisciplina(disciplina, statusOverrides[slug], unlockOverrides[slug] ?? false, avaliacaoStatus);
