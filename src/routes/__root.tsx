...
const themeInitScript = `(function(){try{var t=localStorage.getItem('uxa-theme');if(t==='dark'){document.documentElement.classList.add('dark');}}catch(e){}})();`;
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "UX Academy — Pós em UX Design" },
      { name: "description", content: "Plataforma pessoal de estudos da pós-graduação em UX Design da Unicesumar." },
    ],
